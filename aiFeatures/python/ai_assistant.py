...
def initialize_rag():
    ...
    if choice == "1":
        ...
        print("\n No PDFs will be loaded. The assistant will work without document-based responses.")
...
if vector_store:
    ...
    print("\n No PDFs loaded. The AI will answer questions without document-based knowledge.")
