...
llm_shunya = ChatGoogleGenerativeAI(model="gemini-2.0-flash")  
llm_pratham = ChatGoogleGenerativeAI(model="gemini-2.0-flash")  
llm_dviteey = ChatGoogleGenerativeAI(model="gemini-2.0-flash")  
...
def create_shunya_prompt_with_history(session: ChatSession):
    ...
    return ChatPromptTemplate.from_messages([
        ("system", "You are an experienced AI study caompanion named NADS."
                   "Your name is NADS."
...
def create_dviteey_prompt_with_history(session: ChatSession):
    ...
    return ChatPromptTemplate.from_messages([
        ("system", "You are an expert AI study companion named NADS."
                   "Your name is NADS."
